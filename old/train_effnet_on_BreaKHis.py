...
from BreaKHisDataset import getBreaKHisDatasetSplits
...
mlflow.set_experiment("effnetb7_breaKHis")
...
#     mlflow.log_param("valsize", valsize)
    ...
    train_set, test_set = getBreaKHisDatasetSplits(valsize, testsize, trainsize=trainsize, train_transform=preprocess_effnetb7,                                  val_test_transform=preprocess_effnetb7, limit=dataset_limit, balanced=balanced)
